...
export class TileLayer extends GridLayer {
    ...
    getTileUrl(coords: LO.Coords): string;

    protected _tileOnLoad(done: LO.DoneCallback, tile: HTMLElement): void;
    protected _tileOnError(done: LO.DoneCallback, tile: HTMLElement, e: Error): void;
...
export class Map extends Evented {
    ...
    // Properties
    attributionControl: LO.Control.Attribution;
    boxZoom: Handler;
